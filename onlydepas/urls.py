...
from app.views import actualizar_usuario, registro_usuario,index,detalle_inmueble, generar_solicitud_arriendo,alta_inmueble,solicitudes_arrendador,dashboard,cambiar_estado_solicitud
